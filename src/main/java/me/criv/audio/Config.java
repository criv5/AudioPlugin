...
public class Config {
    ...
    public static void createDefaults() {
        ...
        if(config.get("fade-time-seconds") == null) {
            config.set("fade-time-seconds", 4);
        }
        if(config.get("fade-maximum-height-blocks") == null) {
            config.set("fade-maximum-height-blocks", 32);
        }
        instance.saveConfig();
    }
    ...
    public static double getFadeHeight() {
        return config.getDouble("fade-maximum-height-blocks");
    }
    ...
    public static void setFadeHeight(double blocks) {
        config.set("fade-maximum-height-blocks", blocks);
        instance.saveConfig();
    }
}
